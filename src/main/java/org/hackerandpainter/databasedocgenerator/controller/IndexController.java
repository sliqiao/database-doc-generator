...
public class IndexController {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "dbType", value = "1:MySQL\n2:Oracle\n3:PostgreSQL\n4:SQLServer", defaultValue = "3", required = true),
            @ApiImplicitParam(name = "ip", value = "ip地址", defaultValue = "123.56.106.137", required = true),
            @ApiImplicitParam(name = "databaseName", value = "数据库名", defaultValue="markingdb",required = true),
            @ApiImplicitParam(name = "port", value = "端口", defaultValue = "8888", required = true),
            @ApiImplicitParam(name = "userName", value = "用户名", defaultValue = "pguser", required = true),
            @ApiImplicitParam(name = "password", value = "密码", defaultValue = "isatcecepkg", required = true),
